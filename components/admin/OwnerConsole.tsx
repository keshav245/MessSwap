...
import { CheckCircle2, Clock3, ClipboardList, Search, Shield, Users, XCircle } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2">
        ...
        <BroadcastComposer adminId={adminId} />
      </div>
      ...
      <div className="mt-10">
        ...
        <p className="text-sm text-steel">Look up hostellers and day scholars, view their details, or message them.</p>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          {filteredUsers.length > 0 ? (
            filteredUsers.map((u) => <UserCard key={u.id} user={u} adminId={adminId} />)
          ) : (
            <div className="flex flex-col items-center gap-2 rounded-lg border border-dashed border-steelLight py-10 text-center sm:col-span-2">
              <Search size={20} className="text-steel" strokeWidth={1.5} />
